...
INSERT INTO paciente (
    id_pac,nome_pac, data_nascimento_pac, idade_pac, local_nascimento_pac, rg_pac, cpf_pac,
    endereco_pac, telefone_pac, profissão_pac, estado_civil_pac, email_pac, sexo_pac, 
    raca_pac, id_resp_fk)
VALUES
(null, 'Laura Souza', '2012-07-15', 13, 'São Paulo', '45.678.901-3', '456.789.012-33',
 'Rua das Flores, 200', '(11) 97777-8888', 'Estudante', 'Solteira', 'laura.souza@email.com',
 'Feminino', 'Branca', null);

 ALTER TABLE paciente CHANGE profissão_pac profissao_pac VARCHAR(100);